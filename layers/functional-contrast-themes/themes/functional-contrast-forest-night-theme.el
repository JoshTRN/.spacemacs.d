...
(custom-theme-set-faces
 ...
 '(outline-1 ((t (:foreground "#AE81FF" :height 1.4 :weight bold :inherit variable-pitch))))
 '(outline-2 ((t (:foreground "#00FFBF" :height 1.2))))
 '(outline-3 ((t (:foreground "#CDD581" :height 1.1))))
 '(outline-4 ((t (:foreground "#00BFFF"))))
 '(outline-5 ((t (:foreground "#CDD581"))))
 '(outline-6 ((t (:foreground "#00d364"))))
 '(outline-7 ((t (:foreground "#AE81FF"))))
 '(outline-8 ((t (:foreground "#00BFFF"))))
 ...
 `(org-verbatim ((t (:foreground "#CDD581" :background ,solaire-bg :extend t :inherit fixed-pitch :family "Fira Code"))))
 ...
 `(org-block ((t (:foreground "white" :background ,solaire-bg :extend t :inherit fixed-pitch :family "Fira Code"))))
 `(org-code ((t (:foreground "#CDD581" :background ,solaire-bg :extend t :inherit fixed-pitch :family "Fira Code"))))
 ...
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#011f18" :foreground "slategray1" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "CTDB" :family "Fira Code"))))
 )
