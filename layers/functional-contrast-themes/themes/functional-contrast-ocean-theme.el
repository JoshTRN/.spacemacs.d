...
(custom-theme-set-faces
 ...
 `(org-block ((t (:foreground "white" :extend t :inherit fixed-pitch :family "Fira Code" :background ,solaire-bg))))
 ...
 `(default ((t (:inherit nil :extend nil :stipple nil :background ,bg-color :foreground "slategray1" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "CTDB" :family "Fira Code"))))
 )
